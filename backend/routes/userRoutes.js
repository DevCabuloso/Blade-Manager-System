...
router.get('/cadastros/pendentes', authenticateToken, requireRole('admin'), getPendingRegistrations);
router.put('/:id/aprovar-cadastro', authenticateToken, requireRole('admin'), approveRegistration);
