...
const backendHost = process.env.VITE_BACKEND_URL || (isDocker ? 'http://backend:8000' : 'http://localhost:8000');
...
export default defineConfig({
  ...
  define: {
    'import.meta.env.VITE_BACKEND_URL': JSON.stringify(backendHost),
  },
  server: { 
    open: true,
    host: true,
